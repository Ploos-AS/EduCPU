...
def plan(cpu):
    ...
    if op not in (0x00,0x13,0x15,0x17,0x18,0x19,0x24,0x25,0x30,0x31,0x32,0x33,0x34,0x35,0x36,0x38,0x39,0x40,0x01):
...
class MicroStepper:
    ...
    def next(self):
        ...
        step=self.steps[self.index];self.index+=1;committed=False
