module tb_experimental_irq_entry;
 ...
 initial begin
  ...
  repeat(3) tick;
  if(!state_write||next_pc!=16'h8000||next_sp!=16'hfefd) $fatal(1,"entry state");
  ...
  repeat(3) tick;
  if(!state_write||!iret_complete||next_pc!=16'h1234||next_sp!=16'hff00||next_flags!=8'h05) $fatal(1,"iret");
